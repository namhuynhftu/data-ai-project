...
def submit_flink_sql_job(sql_file: str, flink_container: str = "flink_jobmanager"):
    ...
    try:
        ...
        logger.info(f"   1. Flink Web UI: http://localhost:8081")
        ...
        logger.info("")
        logger.info("⚠️  Note: The job will run continuously until manually stopped")
...
def main():
    """Main entry point."""
    # Path to SQL file
    sql_file = "elt_pipeline/streaming/flink/transaction_monitor.sql"
