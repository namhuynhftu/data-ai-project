...
-- Import products data (with better error handling)
SET SESSION sql_mode = '';  -- Allow malformed data to be imported with warnings
...
SET SESSION sql_mode = 'TRADITIONAL';  -- Restore strict mode

-- Import orders data (with better error handling)
SET SESSION sql_mode = '';  -- Allow malformed data to be imported with warnings
